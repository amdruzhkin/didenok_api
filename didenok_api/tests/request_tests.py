...
# response = requests.get(host+"/node/9ae1e0ca-fe1a-464b-9471-15e41a52847a/statistic?dateStart=2022-05-27T21%3A12%3A01.000Z&dateEnd=2022-05-29T21%3A12%3A01.000Z")
# print(response.text)

response = requests.get(host+"/node/9ae1e0ca-fe1a-464b-9471-15e41a52847a/statistic")
print(response.text)